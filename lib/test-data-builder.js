...
TestDataBuilder.prototype.buildTo = function (context, callback) {
  ...
  async.eachSeries(this._definitions, this._buildObject.bind(this), callback)
}
...
TestDataBuilder.prototype._buildObject = function (definition, callback) {
  ...
  var values = Object.assign(defaultValues, definition.properties || {})
...
Reference.prototype.resolveFromContext = function (context) {
  ...
  var result = elements.reduce(function (obj, prop) {
    return obj[prop]
  }, context)
